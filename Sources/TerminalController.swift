...
class TerminalController {
    ...
    /// Main-actor grant registry for file-backed mobile panels.
    ///
    /// The registry is deliberately separate from the terminal artifact actor:
    /// panel descriptors and reads both resolve on the app's main actor, where
    /// the live panel path is authoritative.
